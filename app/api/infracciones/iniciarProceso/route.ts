...
export async function PATCH(request: Request) {
  try {
    ...
    const {
      id, es_titular,
      nombre_titular, appaterno_titular, apmaterno_titular, curp_titular, correo_titular,
      nombre_infractor, appaterno_infractor, apmaterno_infractor, curp_infractor, correo_infractor,
    } = body;
    ...
    `, [
      id, infraccion.folio, nombreUsuario, apellidosUsuario, CONCEPTO_PRUEBA,
      orden_pago_id, estatus, url_pago, url_guardado, folio_orden,

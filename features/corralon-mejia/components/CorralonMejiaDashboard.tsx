...
const STATUS_TABS: { key: EstatusMejia; label: string; icon: typeof Clock; color: string; accent: string; bg: string }[] = [
...
export default function CorralonMejiaDashboard({
    ...
    console.log(onSubirComprobante)
    const [filtro, setFiltro] = useState<EstatusMejia>('PENDIENTE')

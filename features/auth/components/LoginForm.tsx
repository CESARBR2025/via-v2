            ...
            <div className="w-full lg:w-1/2 p-5 lg:p-8 flex flex-col">
                <div className="relative flex-1 bg-gradient-to-b from-blue-800 via-blue-900 to-blue-950 rounded-2xl overflow-hidden flex flex-col shadow-2xl">
                    ...
                    <div className="relative z-10 flex-1 flex flex-col justify-between px-12 py-14 lg:py-20 lg:px-14">
                        {/* ─── Collage: imágenes superpuestas centro-derecha → centro-izquierda ─── */}
                        ...
                        <div className="absolute inset-0 overflow-hidden pointer-events-none select-none">
                            ...
                            <div style={{
                                transform: 'perspective(1300px) rotateY(-20deg) rotateX(10deg) rotate(1deg)',
                                ...
                                <Image fill src="/login-preview/01-dashboard.png" alt="Dashboard oficial" className="object-cover" sizes="(max-width: 1024px) 50vw, 25vw" />
                            </div>
                            ...
                            <div style={{
                                ...
                                <Image fill src="/login-preview/02-ubicacion.png" alt="Dashboard oficial" className="object-cover" sizes="(max-width: 1024px) 50vw, 25vw" />
                            </div>
                            ...
                            <div style={{
                                ...
                                <Image fill src="/login-preview/03-orden-pago.png" alt="Dashboard oficial" className="object-cover" sizes="(max-width: 1024px) 50vw, 25vw" />
                            </div>

                            {/* ① Dashboard — fondo abajo-derecha */}
                            <div style={{
                                transform: 'perspective(1300px) rotateY(-15deg) rotateX(10deg) rotate(0deg)',
                                ...
                                <Image fill src="/login-preview/07-dashboard-admin.png" alt="Dashboard oficial" className="object-cover" sizes="(max-width: 1024px) 50vw, 25vw" />
                            </div>
                            {/* ① Dashboard — fondo abajo-derecha */}
                            <div style={{
                                transform: 'perspective(1300px) rotateY(-15deg) rotateX(10deg) rotate(0deg)',
                                ...
                                <Image fill src="/login-preview/06-dashboard-admin.png" alt="Dashboard oficial" className="object-cover" sizes="(max-width: 1024px) 50vw, 25vw" />
                            </div>
